    ...
    <div className="antialiased relative min-h-screen">
      ...
      {!isInstalled && showPrompt && (isInstallable || isIOS) && (
        <div className="fixed inset-0 z-[999] flex items-center justify-center bg-black/60 backdrop-blur-md px-6">
          <div className="bg-[#0f172a] text-white rounded-2xl shadow-2xl max-w-sm w-full p-6 text-center space-y-4">
            ...
            {!isIOS ? (
              <p className="text-sm text-white/80">
                Agrega MiPapantla a tu pantalla de inicio para una experiencia fluida y como una app real.
              </p>
            ) : (
              <p className="text-sm text-white/80">
